...
public class Library {
    ...
    public Library(ArrayList<Book> bookList, ArrayList<Student> studentList, ArrayList<Borrowings> borrowingList) {
    ...
    public void listStudentBorrowings(ArrayList<Borrowings> borrowingsList, String searchedStudent) {
        ...
        ArrayList<Borrowings> currentBorrowings = new ArrayList<Borrowings>();
        ...
        for (Borrowings studentBorrowings : borrowingsList) { //Creates a loop to go through the borrowings List line by line 
            ...
            if (searchedStudent.equals(studentBorrowings.studentID)) { //if the user input is equals to the a student ID in our Borrowings List it will print the Book title
                currentBorrowings.add(studentBorrowings);
         ...
         if (currentBorrowings.isEmpty()){
             ...
             System.out.println("Student" + searchedStudent +  " has no borrowings");
             
            
         }else{
         
         System.out.println("The student with the ID " + searchedStudent + " has borrowed the following books: ");
         
         for(Borrowings borrowing : currentBorrowings){
